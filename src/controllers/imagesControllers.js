...
module.exports = {
  ...
  updateUserProfilePicture: async (req, res) => {
    ...
    try {
      ...
      const currentId =
        await usersQueries.getUserProfilePicturePublicId(userId);
      ...
      await usersQueries.updateUserProfilePicture(
        userId,
        result.secure_url,
        result.public_id,
      );
  ...
  updateRealmPicture: async (req, res) => {
    ...
    try {
      ...
      await realmsQueries.updateRealmPicture(
        realmId,
        result.secure_url,
        result.public_id,
      );
