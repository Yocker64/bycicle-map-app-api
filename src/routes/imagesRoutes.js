...
router.put(
  ...
  imagesControllers.updateUserProfilePicture,
);
...
router.put(
  '/:id/realm-picture',
  isAuthorized('realm'),
  upload.single('realmPicture'),
  imagesControllers.updateRealmPicture,
);
...
router.post(
  '/:id/socket/upload',
  isAuthorized('user'),
  upload.single('socketImage'),
  imagesControllers.uploadSocketImage,
);
